...
# NEW VARIABLES FOR EASY UPDATES
BYPASS_API_KEY = os.environ.get("BYPASS_API_KEY", "SH4DAW-D4DY")
FORCE_SUB_LINK = os.environ.get("FORCE_SUB_LINK", "https://t.me/+4hW0nmW34rRjN2Fl")
...
@server.route('/')
def status(): return '𝗢𝗪𝗡𝗘𝗥 𝗢𝗡𝗟𝗬 𝗕𝗢𝗧 𝗢𝗡𝗟𝗜𝗡𝗘'
...
async def is_subscribed(client, message):
    ...
    try:
        ...
        await message.reply_text(
            ...
            f"**𝗬𝗢𝗨 𝗠𝗨𝗦𝗧 𝗝𝗢𝗜𝗡 𝗢𝗨𝗥 𝗚𝗥𝗢𝗨𝗣 𝗧𝗢 𝗕𝗬𝗣𝗔𝗦𝗦 𝗟𝗜𝗡𝗞𝗦!**",
...
# --- 𝗨𝗦𝗘𝗥 𝗟𝗢𝗚𝗜𝗖 (𝗡𝗢𝗪 𝗪𝗜𝗧𝗛 𝗢𝗪𝗡𝗘𝗥 𝗖𝗛𝗘𝗖𝗞) ---
@app.on_message(filters.command("start") & filters.private)
async def start(client, message):
    # ⚠️ OWNER CHECK: Only Admin can use start
...
async def handle_bypass(client, message):
    ...
    # ⚠️ OWNER CHECK: Only Admin can bypass
    if message.from_user.id != ADMIN_ID:
        return await message.reply_text("❌ **𝗔𝗖𝗖𝗘𝗦𝗦 𝗗𝗘𝗡𝗜𝗘𝗗! 𝗢𝗡𝗟𝗬 𝗧𝗛𝗘 𝗢𝗪𝗡𝗘𝗥 𝗖𝗔𝗡 𝗕𝗬𝗣𝗔𝗦𝗦 𝗟𝗜𝗡𝗞𝗦.**")
